...
proj_name_hr = f'{h10name_hr} {proj_type.replace('_', ' ')}({timeframe[:-1]})'
...
with open(log_path, 'w') as f:
    ...
    readme_out_path = add_file(readme_path, proj_path, outdir)
...
for i in [5, 10, 30]:
    ...
    for e in epochs:
        ...
        cur_awm = area_weighted_mean(cur_anomalies,  lyr2[['HUC12', 'area_sqkm']])
